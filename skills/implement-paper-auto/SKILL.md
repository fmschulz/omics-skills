...
- `/marimo-notebook` — target format for the reproduction notebook
- `/biorxiv-search` — locate the paper on bioRxiv before reproducing
- `/arxiv-search` — locate the paper on arXiv before reproducing
- `/add-molab-badge` — advertise the reproduction notebook
