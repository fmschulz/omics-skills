...
- `/jupyter-to-marimo` — convert an existing .ipynb to marimo
- `/anywidget` — generate a custom widget component for the notebook
- `/add-molab-badge` — advertise the notebook with an Open-in-molab badge
- `/implement-paper-auto` — reproduce a paper end-to-end in a marimo notebook
- `/notebook-ai-agents-skill` — refactor Jupyter/agent notebooks if not starting from scratch
